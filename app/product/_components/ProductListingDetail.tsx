            ...
            <div className="grid gap-3">
              ...
              {listing.is_buy_now && (
                <div className="grid gap-1.5 pt-2 border-t border-slate-100">
                  <span className="text-xs font-bold uppercase tracking-wide text-[#006d40]">Buy</span>
                  <button
                  ...
                  >
                    <span>{!token ? "Log in to Buy" : "Buy"}</span>
                    {listing.bin_price_per_unit && (
                      <span className="font-mono text-sm opacity-80">{listing.currency} {listing.bin_price_per_unit}/MT</span>
                    )}
                  </button>
                </div>
              )}
