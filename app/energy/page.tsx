    ...
    <div className={`${inter.className} min-h-screen bg-[#030d0d] text-white antialiased`}>
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-[#030d0d]/90 backdrop-blur-md">
        <div className="mx-auto flex h-16 w-full max-w-[1440px] items-center justify-between px-6 md:px-12">
          ...
          <nav className="hidden gap-7 md:flex text-[13.5px] font-medium text-white/60">
            <Link href="/" className="hover:text-white transition-colors">← Commodity Platform</Link>
      ...
      <main className="pt-16">
        ...
        <section className="relative flex min-h-[500px] items-center overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-[#001a1a] via-[#030d0d] to-[#030d0d]" />
          <div className="absolute -top-40 -left-40 h-[600px] w-[600px] rounded-full bg-[#00bfa5]/10 blur-[140px]" />
          <div className="absolute -bottom-20 right-10 h-[400px] w-[400px] rounded-full bg-[#006d40]/15 blur-[120px]" />
          ...
          <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 py-20 md:px-12">
            <div className="max-w-3xl">
              ...
              <h1 className={`${hanken.className} mt-7 text-[40px] font-extrabold leading-[1.1] tracking-tight md:text-[60px]`}>
                Powering Africa's{" "}
          ...
          <div className="mx-auto flex max-w-[1440px] flex-wrap items-center justify-center gap-x-14 gap-y-4 px-6 py-6 md:px-12 md:justify-between">
            {[
              ...
              <div key={stat.label} className="flex flex-col items-center text-center md:items-start md:text-left">
                ...
                <span className={`${jetbrains.className} text-[11px] font-medium tracking-widest text-white/50 uppercase`}>{stat.label}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="px-6 py-24 md:px-12">
          <div className="mx-auto max-w-[1440px]">
            <div className="mb-14 text-center">
              <span className={`${jetbrains.className} text-[11px] tracking-[0.15em] text-[#00bfa5] uppercase font-medium`}>Our Services</span>
              <h2 className={`${hanken.className} mt-3 text-[34px] font-bold leading-tight md:text-[46px]`}>
                Complete Energy Solutions
              </h2>
              <p className="mt-4 text-[15px] leading-relaxed text-white/55 max-w-xl mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {energyServices.map((service) => (
                <Link
                  ...
                  className="group relative flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/5 transition duration-300 hover:-translate-y-1 hover:border-white/20 hover:shadow-[0_16px_64px_rgba(0,0,0,0.5)]"
                >
                  {/* image */}
                  <div className="relative h-44 w-full overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#030d0d] via-[#030d0d]/50 to-transparent" />
                    <div className="absolute bottom-4 left-5 flex h-11 w-11 items-center justify-center rounded-xl border border-white/20 bg-white/10 text-xl backdrop-blur-sm">
                      {service.icon}
                    </div>
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    <p className={`${jetbrains.className} text-[10px] tracking-widest text-white/35 uppercase`}>{service.tagline}</p>
                    <h3 className={`${hanken.className} mt-1.5 text-[18px] font-bold text-white`}>{service.title}</h3>
                    <p className="mt-2 text-[13px] leading-relaxed text-white/55 flex-1 line-clamp-3">{service.description}</p>
