...
import PromptModal from "@/components/bidding/PromptModal";
    ...
    <div className="flex w-full min-h-screen bg-surface-gray font-body-md text-on-background">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-body-md text-on-surface-variant">
                {currentEnquiry.reference} · Buyer: Confidential
              </p>
            </div>
      ...
      {showDeclineModal && (
        <PromptModal
          ...
          message="Please provide a reason for declining this enquiry."
          placeholder="e.g. We are currently out of stock."
          confirmText="Decline"
          onConfirm={handleDecline}
          onCancel={() => setShowDeclineModal(false)}
          isSubmitting={status.declineEnquiry === "loading"}
        />
      )}
    </div>
  );
